      ...
      <div className="flex w-[736px] flex-col">
        <div className="flex w-full justify-between">
          <div className="flex gap-2 items-center">
            <p className="text-sm text-[#4EA8DE] font-bold">Tarefas criadas</p>
            <div className="flex items-center justify-center bg-[#262626] w-[25px] h-[19px] rounded-full">
              <p className=" text-white text-xs font-bold">0</p>
            </div>
          </div>
          <div className="flex gap-2 items-center">
            <p className="text-sm text-[#4EA8DE] font-bold">Concluídas</p>
            <div className="flex items-center justify-center bg-[#262626] w-[25px] h-[19px] rounded-full">
              <p className=" text-white text-xs font-bold">0</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center mt-6 w-full rounded-lg border-t border-gray-600">
          <svg
            width="56"
            height="56"
            viewBox="0 0 56 56"
          ...
          <p className="mt-4 text-[#808080] mb-16">
            <strong>Você ainda não tem tarefas cadastradas</strong>
            <br></br>Crie tarefas e organize seus itens a fazer
          </p>
        </div>
      </div>
    </>
